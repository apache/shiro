...
public class SimpleAuthenticationEventFactory implements AuthenticationEventFactory {
    ...
    /**
     * Uses the Principal found in the token to construct a {@link FailedAuthenticationEvent}
     ...
     * @return a {@link FailedAuthenticationEvent} to send due to the failed attempt.
     */
     ...
     * construct a {@link SuccessfulAuthenticationEvent}
     * @param token the authentication token submitted during the authentication attempt.
     * @param info the authentication info constructed due to the successful attempt.
     * @return a {@link SuccessfulAuthenticationEvent} to send due to the successful attempt.
     */
