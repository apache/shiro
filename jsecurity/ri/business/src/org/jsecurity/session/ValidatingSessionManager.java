...
public interface ValidatingSessionManager extends SessionManager {
     ...
     * updating a session's {@link Session#getLastAccessTime() last access time} may call the
     ...
     * @throws InvalidSessionException if, upon validation, the session was stopped or expired.
     */
