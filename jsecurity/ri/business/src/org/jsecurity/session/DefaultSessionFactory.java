...
/**
 * Default JSecurity reference implementation of a {@link SessionFactory}.  This implementation
 * returns instances where all methods delegate to a corresponding
 * {@link SessionManager SessionManager} method call.  That is, the objects returned act as
 ...
 * All instances should be acquired from this {@link SessionFactory SessionFactory} at the
