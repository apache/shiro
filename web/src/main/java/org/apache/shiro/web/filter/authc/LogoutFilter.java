...
public class LogoutFilter extends AdviceFilter {
     ...
     * {@code Subject.}{@link Subject#getSession(boolean) getSession(false)} method to ensure a new session
     * isn't created unnecessarily. If a session was created, it will be immediately stopped after logout,
     * not providing any value and unnecessarily taxing session infrastructure/resources.
     *
     * @param request  the incoming Servlet request
     * @param response the outgoing ServletResponse
