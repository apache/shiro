...
public final class WebUtils {
    ...
    /**
     * {@link org.apache.shiro.session.Session Session} key used to save a request and later restore it,
     * for example when redirecting to a
    ...
    public static String decodeRequestString(HttpServletRequest request, String source) {
        ...
        try {
            ...
            if (LOGGER.isWarnEnabled()) {
                LOGGER.warn("Could not decode request string [" + Encode.forHtml(source)
