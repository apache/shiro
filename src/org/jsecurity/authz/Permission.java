 ...
 * granular, i.e. atomic, unit in a system's security policy and is the cornerstone upon which fine-grained security
 * models are built.
 *
 ...
 * role names in your code.  In this environment,
 * roles themselves arent aren't very useful.  What matters is what
 ...
 * a simple exercise of associating Permissions to roles, users, and groups in some way.
 *
