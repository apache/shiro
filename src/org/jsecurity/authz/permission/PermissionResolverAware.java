...
/**
 * Interface implemented by a component wishes to use any application-configured <tt>PermissionResolver</tt> that might
 * already exist instead of potentially creating one itself.
 *
